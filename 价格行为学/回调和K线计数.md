...
15. 双顶和双底形态
    ...
    ![alt text](assets/回调和K线计数/image-2.png)
...
18. 背靠背高2或低2（高4或低4）
    ...
    - 通常交易的点在高4或低4时，成功率更高
    ![alt text](assets/回调和K线计数/image-3.png)
    ![alt text](assets/回调和K线计数/image-4.png)
19. 每次出现突破时，寻找下一次回调，然后重新进行计数
20. 回调持续扩大的情况，如果在牛市中出现回调形成能第四个高点，而市场继续下行，回调的趋势可能转变为相反方向的趋势。
![alt text](assets/回调和K线计数/image-5.png)
![alt text](assets/回调和K线计数/image-6.png)
...
![alt text](assets/回调和K线计数/image-7.png)
23.  交易时也要考虑更低时间框架的情况，有时市场会在5分钟图标上形成首次触及高位（高点1）的形态，但是它可能在一分钟图表上形成一个高点2形态
![alt text](assets/回调和K线计数/image-8.png)
...
![alt text](assets/回调和K线计数/image-9.png)
